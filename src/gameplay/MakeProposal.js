...
class MakeProposal extends Component{
    ...
    async makeRenderRedirectToVoteTrue(){
        await axios.post(`/api/createvotecolumn`,{attempt:1,quest:1,matchName:this.props.match.params.matchName,teamleader:this.props.match.params.playerNumber,playeronquest1:3,playeronquest2:9,playeronquest3:10,playeronquest4:null,playeronquest5:null});
